...
export const getStages = withErrorLogging(
  getStagesFn,
...
const getAvailableStagesFn = (stage = "deals") => axios.get("/stages/" + stage);
export const getAvailableStages = withErrorLogging(
  getAvailableStagesFn,
...
const getAvailableAfterSalesStagesFn = () => axios.get("/stages/after-sales");
export const getAvailableAfterSalesStages = withErrorLogging(
  getAvailableAfterSalesStagesFn,
