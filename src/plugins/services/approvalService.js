...
export const getApprovals = withErrorLogging(getApprovalsFn, "approvalService.getApprovals");

const createApprovalFn = async (phone, user_id = null) => {
  return await axios.post("/approvals", { phone: phone, user_id: user_id });
};
export const createApproval = withErrorLogging(createApprovalFn, "approvalService.createApproval");
...
export const updateApproval = withErrorLogging(updateApprovalFn, "approvalService.updateApproval");

const getTotalsFn = async () => {
  return await axios.get("/approvals/get-totals");
};
export const getTotals = withErrorLogging(getTotalsFn, "approvalService.getTotals");
